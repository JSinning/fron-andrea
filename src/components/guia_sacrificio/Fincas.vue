      ...
      <div class="card mt-5 pt-3">
        <div class="flex flex-row flex-wrap mb-2">
          ...
          <div class="md:w-1/2 px-3 mb-6 md:mb-0">
            ...
            <input type="text" class="input" v-model="descripcionFin" />
          </div>
          <div class="md:w-1/2 px-3 mb-6 md:mb-0"></div>
          <div class="md:w-1/2 px-3 mb-6 md:mb-0">
            <label class="label">Propietario:</label>
            <input type="text" class="input" v-model="propietario" />
          </div>
          <div class="md:w-1/2 px-3 mb-6 md:mb-0"></div>
          <div class="md:w-1/2 px-3 mb-6 md:mb-0">
            <label class="label">Contacto:</label>
            <input type="text" class="input" v-model="contacto" />
          </div>
          <div class="md:w-1/2 px-3 mb-6 md:mb-0"></div>
          <div class="md:w-1/2 px-3 mb-6 md:mb-0">
            <label class="label">Ciudad:</label>
            <select class="select" v-model="ciudad">
              <option
          ...
          <div class="md:w-1/2 px-3 mb-6 md:mb-0">
            ...
            <input type="text" class="input" v-model="vereda" />
          </div>
          <div class="md:w-1/2 px-3 mb-6 md:mb-0"></div>
          <div class="md:w-1/2 px-3 mb-6 md:mb-0">
          ...
          <div class="md:w-1/2 px-3 mb-6 md:mb-0">
            ...
            <input type="text" class="input" v-model="ubicacion" />
          </div>
        </div>
      </div>
    </div>
...
export default class Fincas extends Vue {
  ...
  private async addLands() {
    this.isLoading = true;
    try {
      const response = await this.guiaSacrificioApi.postFicas({
        ciudadF: this.ciudad,

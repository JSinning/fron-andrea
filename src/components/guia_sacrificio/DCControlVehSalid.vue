    ...
    <div class="main-div mb-2">
      ...
      <div class="flex flex-row flex-wrap justify-end">
        <div class="mb-6 md:mb-0 mt-2">
          <button class="btn-save" @click="modifyRegister" v-if="false">
            Modificar registro
          </button>
        </div>
        <div class="mb-6 md:mb-0 mt-2">
          <button class="btn-primary" @click="updateVehSalid">Guardar</button>
        </div>
      </div>
        ...
        <div class="flex flex-row flex-wrap">
          <div class="md:w-1/2 px-3 mb-6 md:mb-0">
            ...
            <input
              type="text"
              class="input"
              v-model="dcControlVehSalid.idPesaje"
              :readonly="readonly"
            />
          </div>
          ...
          <div class="md:w-1/2 px-3 mb-6 md:mb-0">
            ...
            <input
              ...
              ref="documentRef"
              class="input"
              v-model="dcControlVehSalid.document"
              :readonly="readonly"
            />
          </div>
          ...
          <div class="md:w-1/2 px-3 mb-6 md:mb-0">
            ...
            <input
              type="date"
              class="input"
              v-model="dcControlVehSalid.fechaPes"
              :readonly="readonly"
            />
          </div>
          ...
          <div class="md:w-1/2 px-3 mb-6 md:mb-0">
            ...
            <input
              type="text"
              class="input"
              v-model="dcControlVehSalid.placaVeh"
              :readonly="readonly"
            />
          </div>
          ...
          <div class="w-full px-3 mb-6 md:mb-0">
            ...
            <div class="flex gap-4">
              <div class="flex gap-4 w-1/2">
                <PaginatedSelect
                  class="flex-1"
                  v-model="dcControlVehSalid.clienteUs"
                  :fetch="itemClienteUs"
                />
                <PaginatedSelect
                  class="flex-1"
          ...
          <div class="md:w-1/2 px-3 mb-6 md:mb-0">
            ...
            <select
              ...
              v-model="dcControlVehSalid.tipoVeh"
            >
              <option
          ...
          <div class="md:w-1/2 px-3 mb-6 md:mb-0">
            ...
            <select
              class="bg-white border py-1 pr-2 select"
              v-model="dcControlVehSalid.tipoTranspPoFs"
            >
              <option
          ...
          <div class="md:w-1/2 px-3 mb-6 md:mb-0">
            ...
            <input
              type="text"
              class="input"
              v-model="dcControlVehSalid.transportador"
              :readonly="readonly"
            />
          </div>
          ...
          <div class="md:w-1/2 px-3 mb-6 md:mb-0">
            ...
            <PaginatedSelect
              v-model="dcControlVehSalid.ciudadDes"
              :fetch="ciudades"
            />
          </div>
          ...
          <div class="w-1/2 px-3 mb-6 md:mb-0">
            ...
            <div class="flex gap-4 w-full">
              <PaginatedSelect
                class="flex-1"
                v-model="dcControlVehSalid.conductorV"
          ...
          <div class="md:w-1/2 px-3 mb-6 md:mb-0">
            ...
            <input
              type="text"
              class="input"
              v-model="dcControlVehSalid.persProgramo"
              :readonly="readonly"
            />
          </div>
          ...
          <div class="md:w-1/2 px-3 mb-6 md:mb-0">
            ...
            <select
              class="bg-white border py-1 pr-2 select"
              v-model="dcControlVehSalid.tipoProdu"
            >
              <option
            ...
            <div class="flex flex-row flex-wrap p-3 w-full justify-center">
              <div class="md:w-full px-40 mb-6 md:mb-0">
                ...
                <input
                  ...
                  v-model="dcControlVehSalid.fechaHoraE"
                  readonly
                />
              </div>
              <div class="md:w-full px-40 mb-6 md:mb-0">
              ...
              <div class="md:w-full px-40 mb-6 md:mb-0">
                ...
                <select
                  ...
                  v-model="dcControlVehSalid.estadoV"
                >
                  <option
            ...
            <div class="flex flex-row flex-wrap p-3 w-full justify-center">
              <div class="md:w-full px-40 mb-6 md:mb-0">
                ...
                <input
                  type="datetime-local"
                  class="input p-1 text-base"
                  v-model="dcControlVehSalid.fechaHoraS"
                  readonly
                />
              </div>
              <div class="md:w-full px-40 mb-6 md:mb-0">
          ...
          <div class="px-3 mb-6 md:mb-0">
            <div class="md:w-1/2 px-3 mb-6 md:mb-0">
              ...
              <input
                type="text"
                class="input"
                v-model="dcControlVehSalid.realizo"
                readonly
              />
            </div>
            ...
            <div class="md:w-80 px-3 mb-6 md:mb-0">
              ...
              <input
                type="text"
                class="input"
                v-model="dcControlVehSalid.observacion"
                readonly
              />
            </div>
            ...
            <div class="flex flex-row flex-wrap justify-end">
              ...
              <div class="mb-6 md:mb-0 mt-2">
                <button class="btn-primary" @click="viewModalDelete">
                  Imprimir definitiva
                </button>
              </div>
            </div>
          ...
          <div class="bg-white w-full rounded shadow-2xl flex flex-col">
            ...
            >
              <strong class="text-lg"
                ...
                No {{ dcControlVehSalid.idPesaje }}</strong
              >
...
@Component({
  ...
  name: 'DCControlVehSalid',
})
export default class DCControlVehSalid extends Vue {
  @Ref('documentRef') private readonly documentRef: HTMLInputElement;
  ...
  private async acceptModalDelete() {
    if (!this.dcControlVehSalid.idPesaje || this.dcControlVehSalid === null) {
      return;
    }

    this.dcControlVehSalid.procesado = true;
    await this.dcControlVehPdf(this.dcControlVehSalid.idPesaje);
    this.modaldelete = false;
  }
  ...
  private keyDown() {
    window.addEventListener('keydown', (e) => {
      ...
      switch (e.key) {
        ...
        case 'F5':
          if (!this.dcControlVehSalid.procesado) {
            this.showOutput(
              true,
              'Documento con Impresion Preliminar no se puede Modificar',
            );
            return;
          }

          if (this.dcControlVehSalid.estadoV !== 'E') {
            this.showOutput(true, 'Documento con Estado Finalizado');
            return;
          }

          this.dcControlVehSalid.fechaHoraS = moment()
            .utc()
            .format('YYY-MM-DD HH:mm:ss');
          this.dcControlVehSalid.estadoV = 'F';
  ...
  private afterUpdateVehSalid() {
    if (
      !this.dcControlVehSalid.placaVeh ||
      this.dcControlVehSalid.placaVeh === null
    ) {
      this.showOutput(true, 'La Placa no Puede Ser Null');
      return true;
    }
    if (
      this.dcControlVehSalid.fechaPes <
  ...
  private async updateVehSalid() {
    if (this.afterUpdateVehSalid()) {
      return;
    }
    this.dcControlVehSalid.fechaG = moment().utc().format('YYYY-MM-DD');
    this.dcControlVehSalid.estacion = this.$store.getters.getUsuario;

    this.dcControlVehSalid.pesoEntr = Number.parseFloat(this.pesoEntr);
    this.dcControlVehSalid.pesoSali = Number.parseFloat(this.pesoSali);
    this.isLoading = true;
    try {
      const response = await this.guiaSacrificioApi.putDCControlVehMod(
        this.dcControlVehSalid.idPesaje,
  ...
  private async dcControlVehIdPesaje(idPesaje: number) {
    ...
    try {
      ...
      this.dcControlVehSalid = response.data as IDcControlVeh;
      this.dcControlVehSalid.fechaHoraE = this.convertDateHours(
        response.data.fechaHoraE,
      );
      this.dcControlVehSalid.fechaHoraS = this.convertDateHours(
        response.data.fechaHoraS,
      );
      this.dcControlVehSalid.fechaPes = this.convertDate(
        response.data.fechaPes,
      );
  ...
  private onBasculaChanged() {
    this.pesoSali = convertToDecimal(this.pesoBascula);
  }

  private pesoKilosB(peso: number) {
    this.pesoBascula = peso;
    this.pesoSali = convertToDecimal(peso);
  }

...
<template>
  <div class="flex flex-col">
    ...
    <div class="main-div">
      <div class="flex-col">
        <h1 class="title">DECOMISOS 2</h1>
        <div class="flex flex-row flex-wrap justify-center">
          <button class="btn-save" @click="imforme()">Informe</button>
        </div>
...
export default class Descomisos2ViscerasComponet extends Vue {
  ...
  private async imforme() {
    ...
    try {
      const pdf = await this.MovReportesApi.getDecoVisc3PDF();

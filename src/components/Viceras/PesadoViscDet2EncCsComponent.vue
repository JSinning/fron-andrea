    ...
    <div class="flex flex-row flex-wrap mb-3">
      <div class="md:w-1/2 card-table">
        <table class="table-auto w-full text-xs">
          ...
          <tbody
            class="text-center"
            v-for="(item, index) in tablaPesadoDet2"
            :key="index"
          >
            <tr>
              <td>{{ item.Peso1 }}</td>
              <td>{{ item.CanastiCt }}</td>
              <td>{{ item.NumCt }}</td>
              <td></td>
            </tr>
          </tbody>
      ...
      <div class="md:w-1/2 card-table">
        <div class="flex flex-row flex-wrap">
          <div class="px-3 mb-6 md:mb-0">
            ...
            <input type="text" class="input" v-model="SubCarne" />
            <div class="mt-4"></div>
            ...
            <input type="text" class="input" />
            <div class="mt-1"></div>
            <label class="label">Kilos Canastilla:</label>
            <input type="text" class="input" />
          </div>
        </div>
      </div>
...
export default class PesadoViscDet2EncComponent extends Vue {
  private output = '';

      ...
      <div class="flex flex-col">
        <div class="flex items-center p-2">
          <img
            ...
            src="@/assets/img/menu/Reportess.png"
          />
          <span
...
import ReporteAPI from '@/remote/api/reporte/reporteAPI';
...
export default class Reporte extends Vue {
  ...
  private reporteApi = new ReporteAPI(this.$store.getters.getAuthToken);
  ...
  private async menu1() {
    try {
      const response = await this.reporteApi.getMenu1();
      ...
      for (const menuItem of response.data) {
        const menu2 = await this.reporteApi.getMenu2(menuItem.tipo2);
